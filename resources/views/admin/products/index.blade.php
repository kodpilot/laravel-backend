                     ...
                     <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <form
                                ...
                                action="{{ route('product.filter') }}" method="GET">
                                @csrf
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="productsTable">
                                ...
                                <tr class="fw-bolder text-muted">
                                    ...
                                    <th class="min-w-50px">
                                        @if (isset($order))
                                            @if ($order[0] == 'id')
                                                @if ($order[1] == 'asc')
                                                    <a href="{{route('product.sort',['order'=>'id,desc'])}}">{{__('Şirket')}} ID
                                                ...
                                                @else
                                                    <a href="{{route('product.sort',['order'=>'id,asc'])}}">{{__('Şirket')}} ID
                                                    <span class="svg-icon svg-icon-primary svg-icon-2hx"><svg style="height: 1.5rem !important;width:1.5rem !important" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                @endif
                                            @else
                                            <a class="text-muted" href="{{route('product.sort',['order'=>'id,asc'])}}">{{__('Şirket')}} ID</a> 
                                            @endif
                                        @else
                                            <a class="text-muted" href="{{route('product.sort',['order'=>'id,asc'])}}">{{__('Şirket')}} ID</a> 
                                        @endif 
                                    ...
                                    <th class=" min-w-175px">
                                        @if (isset($order))
                                            @if ($order[0] == 'name')
                                                @if ($order[1] == 'asc')
                                                    <a href="{{route('product.sort',['order'=>'name,desc'])}}">{{__('Şirket İsmi')}}
                                                    <span class="svg-icon svg-icon-primary svg-icon-2hx"><svg style="height: 1.5rem !important;width:1.5rem !important" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M11.4343 12.7344L7.25 8.55005C6.83579 8.13583 6.16421 8.13584 5.75 8.55005C5.33579 8.96426 5.33579 9.63583 5.75 10.05L11.2929 15.5929C11.6834 15.9835 12.3166 15.9835 12.7071 15.5929L18.25 10.05C18.6642 9.63584 18.6642 8.96426 18.25 8.55005C17.8358 8.13584 17.1642 8.13584 16.75 8.55005L12.5657 12.7344C12.2533 13.0468 11.7467 13.0468 11.4343 12.7344Z" fill="black"/>
                                                    </svg></span></a>
                                                @else
                                                    <a href="{{route('product.sort',['order'=>'name,asc'])}}">{{__('Şirket İsmi')}}
                                                    <span class="svg-icon svg-icon-primary svg-icon-2hx"><svg style="height: 1.5rem !important;width:1.5rem !important" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M12.5657 11.3657L16.75 15.55C17.1642 15.9643 17.8358 15.9643 18.25 15.55C18.6642 15.1358 18.6642 14.4643 18.25 14.05L12.7071 8.50716C12.3166 8.11663 11.6834 8.11663 11.2929 8.50715L5.75 14.05C5.33579 14.4643 5.33579 15.1358 5.75 15.55C6.16421 15.9643 6.83579 15.9643 7.25 15.55L11.4343 11.3657C11.7467 11.0533 12.2533 11.0533 12.5657 11.3657Z" fill="black"/>
                                                    </svg></span></a>
                                                @endif
                                            @else
                                            <a class="text-muted" href="{{route('product.sort',['order'=>'name,asc'])}}">{{__('Şirket İsmi')}}</a> 
                                            @endif
                                        @else
                                            <a class="text-muted" href="{{route('product.sort',['order'=>'name,asc'])}}">{{__('Şirket İsmi')}}</a> 
                                        @endif 
                                    ...
                                    <th class=" min-w-150px">
                                        @if (isset($order))
                                            @if ($order[0] == 'created_at')
                                                @if ($order[1] == 'asc')
                                                    <a href="{{route('product.sort',['order'=>'created_at,desc'])}}">{{__('Tarih')}}
                                                    <span  class="svg-icon svg-icon-primary svg-icon-2hx"><svg style="height: 1.5rem !important;width:1.5rem !important" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M11.4343 12.7344L7.25 8.55005C6.83579 8.13583 6.16421 8.13584 5.75 8.55005C5.33579 8.96426 5.33579 9.63583 5.75 10.05L11.2929 15.5929C11.6834 15.9835 12.3166 15.9835 12.7071 15.5929L18.25 10.05C18.6642 9.63584 18.6642 8.96426 18.25 8.55005C17.8358 8.13584 17.1642 8.13584 16.75 8.55005L12.5657 12.7344C12.2533 13.0468 11.7467 13.0468 11.4343 12.7344Z" fill="black"/>
                                                    </svg></span></a>
                                                @else
                                                    <a href="{{route('product.sort',['order'=>'created_at,asc'])}}">{{__('Tarih')}}
                                                    <span class="svg-icon svg-icon-primary svg-icon-2hx"><svg style="height: 1.5rem !important;width:1.5rem !important" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M12.5657 11.3657L16.75 15.55C17.1642 15.9643 17.8358 15.9643 18.25 15.55C18.6642 15.1358 18.6642 14.4643 18.25 14.05L12.7071 8.50716C12.3166 8.11663 11.6834 8.11663 11.2929 8.50715L5.75 14.05C5.33579 14.4643 5.33579 15.1358 5.75 15.55C6.16421 15.9643 6.83579 15.9643 7.25 15.55L11.4343 11.3657C11.7467 11.0533 12.2533 11.0533 12.5657 11.3657Z" fill="black"/>
                                                    </svg></span></a>
                                                @endif
                                            @else
                                            <a class="text-muted" href="{{route('product.sort',['order'=>'created_at,asc'])}}">{{__('Tarih')}}</a> 
                                            @endif
                                        @else
                                            <a class="text-muted" href="{{route('product.sort',['order'=>'created_at,asc'])}}">{{__('Tarih')}}</a> 
                                        @endif 
                                    ...
                                    <th class=" min-w-150px">
                                        @if (isset($order))
                                            @if ($order[0] == 'updated_at')
                                                @if ($order[1] == 'asc')
                                                    <a href="{{route('product.sort',['order'=>'updated_at,desc'])}}">{{__('Son Güncelleme')}}
                                                    <span class="svg-icon svg-icon-primary svg-icon-2hx"><svg style="height: 1.5rem !important;width:1.5rem !important" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M11.4343 12.7344L7.25 8.55005C6.83579 8.13583 6.16421 8.13584 5.75 8.55005C5.33579 8.96426 5.33579 9.63583 5.75 10.05L11.2929 15.5929C11.6834 15.9835 12.3166 15.9835 12.7071 15.5929L18.25 10.05C18.6642 9.63584 18.6642 8.96426 18.25 8.55005C17.8358 8.13584 17.1642 8.13584 16.75 8.55005L12.5657 12.7344C12.2533 13.0468 11.7467 13.0468 11.4343 12.7344Z" fill="black"/>
                                                    </svg></span></a>
                                                @else
                                                    <a href="{{route('product.sort',['order'=>'updated_at,asc'])}}">{{__('Son Güncelleme')}}
                                                    <span class="svg-icon svg-icon-primary svg-icon-2hx"><svg style="height: 1.5rem !important;width:1.5rem !important" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M12.5657 11.3657L16.75 15.55C17.1642 15.9643 17.8358 15.9643 18.25 15.55C18.6642 15.1358 18.6642 14.4643 18.25 14.05L12.7071 8.50716C12.3166 8.11663 11.6834 8.11663 11.2929 8.50715L5.75 14.05C5.33579 14.4643 5.33579 15.1358 5.75 15.55C6.16421 15.9643 6.83579 15.9643 7.25 15.55L11.4343 11.3657C11.7467 11.0533 12.2533 11.0533 12.5657 11.3657Z" fill="black"/>
                                                    </svg></span></a>
                                                @endif
                                            @else
                                            <a class="text-muted" href="{{route('product.sort',['order'=>'updated_at,asc'])}}">{{__('Son Güncelleme')}}</a> 
                                            @endif
                                        @else
                                            <a class="text-muted" href="{{route('product.sort',['order'=>'updated_at,asc'])}}">{{__('Son Güncelleme')}}</a> 
                                        @endif 
                            ...
                            <tbody class="products_">
                                <form action="{{route('product.collectiveDelete')}}" method="post">
                                    @csrf
                                @foreach ($products as $product)
                                    <tr id="item-{{$product->id}}">
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input widget-9-check checkboxs"  name="total_check[]" type="checkbox" value="{{$product->id}}" />
                                                {{-- <input type="hidden" name="product_check_id[]" value="{{$product->id}}"> --}}
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="{{ url('assets/images/products/' . ($product->file != null ? $product->file : 'empty.png') ) }}" loading="lazy" alt="" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary fs-6">{{ $product->name }}</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-flex flex-column w-100 me-2">
                                                <div class="d-flex flex-stack mb-2" style="justify-content: start">
                                                    <span
                                                        class="text-muted me-2 fs-7 fw-bold">{{ date('d/m/Y H:i', strtotime($product->created_at)) }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-flex flex-column w-100 me-2">
                                                <div class="d-flex flex-stack mb-2" style="justify-content: start">
                                                    <span
                                                        class="text-muted me-2 fs-7 fw-bold">{{ date('d/m/Y H:i', strtotime($product->updated_at)) }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex justify-content-start flex-shrink-0">
                                                <a href="{{ route('product.edit', ['id' => $product->id]) }}" title="{{__('Düzenle')}}"
                                                ...
                                                <a href="{{ route('product.destroy', ['id' => $product->id]) }}" title="{{__('Sil')}}"
