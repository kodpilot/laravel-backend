...
<head>
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{ url('panel/assets/media/logos/fav.png') }}" type="image/x-icon">
                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                        ...
                        <a href="{{ route('index') }}" class="py-9 mb-5">
                            <img alt="Logo" src="panel/assets/media/logos/kodpilot_logo.svg"
                                class="h-100px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
                        <h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #fff;">{{__('Kodpilot Admin Paneli')}}</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px"
                        style="background-image: url(panel/assets/media/illustrations/login-admin.svg)"></div>
                    <!--end::Illustration-->
                </div>
                <!--end::Wrapper-->
            </div>
